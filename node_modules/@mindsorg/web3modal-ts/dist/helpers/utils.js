...
export function getProviderDescription(providerInfo) {
...
export function filterProviders(param, value) {
    if (!value)
        return providers.FALLBACK;
    const match = filterMatches(Object.values(providers), x => x[param] === value, providers.FALLBACK);
...
export function findMatchingRequiredOptions(requiredOptions, providedOptions) {
